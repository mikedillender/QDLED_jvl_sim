...
Most importantly, Sesame uses Boltzmann carrier statistics. That approximation is questionable in the high-accumulation regime near the QD interfaces. However, given the original paper's application of the Einstein equation, the explicit Boltzmann boundary conditions at the contacts, and the similarity between our electrostatic profiles, I am uncertain whether this is a problem unique to this reconstruction. Although, there are already a number of uncertainties regarding the differences between their stated and actual implementation.
